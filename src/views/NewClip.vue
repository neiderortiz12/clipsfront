        ...
        <div class="field">
            <form ction="" v-on:submit.prevent="createNewClip();"  enctype="multipart/form-data">
                <div >
                    ...
                    <div class="control">
                        <input class="input is-primary" type="text" name="nombre" id="nombre" v-model="form.nombre" placeholder="Nombre del Nuevo Clip">
                    </div>
                </div>
                <div >
                    <label for="" class="label" >Seleccione un Clip</label>
                    <div >
                        <input class="input is-primary" type="file" @change="processFile($event)" >
                    </div>
                </div>
                <div >
                    <label for="" class="label" >Descripción</label>
                    <div class="control">
                        <textarea class="input is-primary" name="descripcion" id="descripcion" v-model="form.descripcion" placeholder="Agregar Una Descripción"></textarea>
                    </div>
                </div>
                <div >
                    <div class="control">
